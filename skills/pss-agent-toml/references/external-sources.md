...
- [From a local file or folder](#from-a-local-file-or-folder)
- [From an installed plugin](#from-an-installed-plugin)
- [From a marketplace plugin (not installed)](#from-a-marketplace-plugin-not-installed)
- [From a GitHub/git repository URL](#from-a-githubgit-repository-url)
- [From a network shared folder](#from-a-network-shared-folder)
- [From a URL to a raw file](#from-a-url-to-a-raw-file)
