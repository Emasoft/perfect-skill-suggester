...
description: "Use when improving categorization, scoring, or matching accuracy via parallel experimentation. Used by pss-agent-profiler. Trigger with /text-categorization-improver."
